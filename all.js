...
{fbuilderjQuery['fbuilder']['extend_window'](fbuilderjQuery['fbuilder']['modules']['cookies']['prefix'],CF_COOKIES);}};$.fbuilder['version']='6.2.98';$.fbuilder['controls']=$.fbuilder['controls']||{};$.fbuilder['forms']=$.fbuilder['forms']||{};$.fbuilder['css']=$.fbuilder['css']||{};$.fbuilder['isNumeric']=function(n){return!isNaN(parseFloat(n))&&isFinite(n);};$.fbuilder['htmlEncode']=window['cff_esc_attr']=function(value)
...
dc.html(opt.messages.discount.replace(/\{\s*\d+\s*\}/,discount).replace(/\{\s*\d+\s*\}/,final_price)).show();}}catch(err){}});}});form.parents('a').attr('href','javascript:void(0);').removeAttr('target').css('all','unset');}});var theForm,ffunct={toShow:{},toHide:{},hiddenByContainer:{},getItem:function(name)
